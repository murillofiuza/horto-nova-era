...
<div id="tp">
	...
	<div class="tp_menu">
			<a href="painel.php"><div class="tp_menu_icon"><img src="img/home_icon1.png"/></div></a>
...
// ============================================
	...
	*********************************************/
	...
	//COLUNA DA TABELA
		...
		echo "<td width='200' bgcolor='#EFEFEF'><center>Visita Técnica</center></td>";
	...
	while ($resultado = mysql_fetch_assoc($query2)){
		...
		$material = $resultado['visita_tecnica'];
	...
	//COLUNA CATEGORIA	
		...
		echo "<center>";
		//echo "<a href='{$link}'>";
		//echo "<img src=../img/upload_orcamento/".$material." alt='Foto de exibição' height='50' width='50' /> ";
		
		//echo "<img src=".$resultado['imagem1']."/>";
