...
OverlayChatWidgetV2.UpdateWMUI = function(){
    ...
    for(var i=lz_ovlel.length-1;i>=0;i--)
    {
        ...
        {
            if(lz_chat_declined || !OverlayChatWidgetV2.IsChatAvailable())
...
OverlayChatWidgetV2.GetAutoMode = function(){
    ...
    if(!lz_hide_widget_by_conf)
    {
        ...
        if((OverlayChatWidgetV2.__ModeCombi || lz_chat_get_wm_element('chat') != null) && (OverlayChatWidgetV2.IsChatAvailable()||OverlayChatWidgetV2.__ModeBot) && !lz_chat_declined && !OverlayChatWidgetV2.__TicketRequired)
            autoMode = 'chat';
    }
    return autoMode;
};
...
OverlayChatWidgetV2.IsChatAvailable = function(){
    return (OverlayChatWidgetV2.__CurrentGroup != null && OverlayChatWidgetV2.__CurrentGroup.Amount > 0) || lz_chat_status > 0;
};
...
OverlayChatWidgetV2.ValidateMode = function(){
    ...
    if(lz_session.OVLWMSElem != autoMode)
    {
        ...
        {
            if((!lz_ticket_when_online || OverlayChatWidgetV2.__ModeSingle) && OverlayChatWidgetV2.IsChatAvailable())
            {
    ...
    if(lz_session.OVLWMSElem == 'chat' && !OverlayChatWidgetV2.__ModeBot && OverlayChatWidgetV2.__CurrentGroup != null && OverlayChatWidgetV2.__CurrentGroup.Amount == 0 && !OverlayChatWidgetV2.__PublicGroupChat.length && lz_chat_status == 0)
    {
        OverlayChatWidgetV2.SetMode("ticket",false);
    }
    else if(lz_session.OVLWMSElem=="ticket" && OverlayChatWidgetV2.__CurrentGroup != null && OverlayChatWidgetV2.__CurrentGroup.Amount > 0 && lz_chat_get_wm_element('ticket') == null)
    {
...
OverlayChatWidgetV2.SetMode = function(_type,_click){
    ...
    else
    {
        ...
        if(OverlayChatWidgetV2.__ModeSingle)
        {
            ...
            <!--FIX:chat widget won't open on mobile-->
...
OverlayChatWidgetV2.UpdateUI = function(){
    ...
    document.getElementById('lz_chat_overlay_data_form_ok_button').innerHTML = (lz_session.OVLWMSElem =="chat") ? ((OverlayChatWidgetV2.__ModeChangeDetails) ? lz_text_save : lz_text_start_chat) : (lz_session.OVLWMSElem=="phone") ? lz_call_me : lz_text_leave_message;
    ...
    if(lz_session.OVLWMSElem =="chat")
    {
        ...
        else if(OverlayChatWidgetV2.__CurrentGroup.ChatInformation.length)
    ...
    if(!OverlayChatWidgetV2.__ModeChangeDetails)
    {
        if(lz_session.OVLWMSElem == "chat" && document.getElementById("lz_chat_invite_id") != null)
            ...
            OverlayChatWidgetV2.__FormVisible = false;
        else if(OverlayChatWidgetV2.__ModeTicketReceived || OverlayChatWidgetV2.__ModeFeedback)
            OverlayChatWidgetV2.__FormVisible = false;
    ...
    document.getElementById("lz_overlay_module_chat").style.display = (!OverlayChatWidgetV2.__FormVisible && lz_session.OVLWMSElem == "chat" && !OverlayChatWidgetV2.__ModeFeedback && !OverlayChatWidgetV2.__ModeChangeDetails) ? "block" : "none";
...
OverlayChatWidgetV2.RemoveFeedback = function(){
    OverlayChatWidgetV2.__ModeFeedback = false;
    OverlayChatWidgetV2.UpdateUI();
};
