...
else
{
    ...
    if((IS_FILTERED && !FILTER_ALLOW_TRACKING) || !empty($deactp) || Cookie::Get(OO_TRACKING_FILTER_NAME) != null)
    {
        if(!IS_FILTERED)
    ...
    else if((!VisitorMonitoring::$CreateUserObject||!VisitorMonitoring::$IsMonitoringActive) && VisitorMonitoring::$Visitor->IsInChat(false,null,true))
    {
	...
	if(JAVASCRIPT)
	{
        ...
        //{
            if(Visitor::$PollCount<=3 && !BaseURL::IsInputURL())
