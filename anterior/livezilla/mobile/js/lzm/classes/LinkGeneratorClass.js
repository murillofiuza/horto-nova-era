...
LinkGeneratorClass.prototype.GetCodeWrapper = function(){
    return '<!-- livezilla.net code --><script type="text/javascript" id="' + this.m_CurrentCodeId +'" src="'+DataEngine.getServerUrl('script.php',this.GetSelectedScheme())+'?id=' + this.m_CurrentCodeId +'"></script><!-- http://www.livezilla.net -->';
};
