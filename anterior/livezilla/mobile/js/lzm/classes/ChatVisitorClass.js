        ...
        if(thisUser != null)
        {
            if(_chatListing)
            {
                ...
                if(list.length > 0)
                {
                    ...
                    else if(d($('#matching-chats-'+elementId+'-table tr')[1]))
                        $('#matching-chats-'+elementId+'-table tr')[1].click();
            ...
            else
            {
                $(['d','e']).each(function()
                {
                    ...
                    if($('#visitor-details-'+elementId+'-list').length)
                    {
                        ...
                        var numberOfInvites = (d(thisUser.r)) ? thisUser.r.length : 0;
...
ChatVisitorClass.prototype.OnMapButtonClicked = function () {
    ...
    if(this.HasWindowWidthForSideBySideView()){
        if(LocalConfiguration.VisitorsMapVisible && LocalConfiguration.VisitorsTreeviewVisible){
            $('#visitor-list-table-div').css({width:(avWidth - this.TreeviewWidth) + 'px'});
            this.HideMap();
        }else if(LocalConfiguration.VisitorsMapVisible){
            $('#visitor-list-table-div').css({width:avWidth + 'px'});
            this.HideMap();
        }else if (LocalConfiguration.VisitorsTreeviewVisible) {
            $('#geotracking').css({width:(avWidth/2 - this.TreeviewWidth/2) + 'px', left: (this.TreeviewWidth + (avWidth/2  - this.TreeviewWidth/2)) + 'px'});
            this.ShowMap();
            $('#visitor-list-table-div').css({width:(avWidth/2 - this.TreeviewWidth/2) + 'px'});
        }else {
            $('#geotracking').css({width:(avWidth/2) + 'px', left: (avWidth/2) + 'px'});
            this.ShowMap();
            $('#visitor-list-table-div').css({width:(avWidth/2) + 'px'});
        }
    }else {
        if(LocalConfiguration.VisitorsMapVisible && LocalConfiguration.VisitorsTreeviewVisible){
            $('#visitor-list-table-div').css({width:(avWidth) + 'px', left: this.TreeviewWidth});
            this.HideMap();
        }else if(LocalConfiguration.VisitorsTreeviewVisible){
            $('#geotracking').css({width:(avWidth - this.TreeviewWidth) + 'px', left: this.TreeviewWidth -1});
            this.ShowMap();
        }else if (LocalConfiguration.VisitorsMapVisible) {
            $('#visitor-list-table-div').css({width:avWidth + 'px', left: '0px'});
            this.HideMap();
        }else {
            this.ShowMap();
            $('#geotracking').css({width:avWidth + 'px', left:'0px'});
        }
    }
};
...
ChatVisitorClass.prototype.OnTreeviewButtonClicked = function () {
    ...
    if(this.HasWindowWidthForSideBySideView()){
        if(LocalConfiguration.VisitorsMapVisible && LocalConfiguration.VisitorsTreeviewVisible){
            this.HideTreeview();
            $('#visitor-list-table-div').css({width:(avWidth/2) + 'px', left:'0px'});
            $('#geotracking').css({width:(avWidth/2) + 'px', left:(avWidth/2) + 'px'});
        }else if(LocalConfiguration.VisitorsMapVisible){
            this.ShowTreeview();
            $('#visitor-list-table-div').css({width:(avWidth/2 - this.TreeviewWidth/2) + 'px', left: this.TreeviewWidth + 'px'});
            $('#geotracking').css({width:(avWidth/2 - this.TreeviewWidth/2) + 'px', left: (this.TreeviewWidth + (avWidth/2  - this.TreeviewWidth/2)) + 'px'});
        }else if (LocalConfiguration.VisitorsTreeviewVisible) {
            this.HideTreeview();
            $('#visitor-list-table-div').css({width:avWidth + 'px', left: 0});
        }else {
            this.ShowTreeview();
            $('#visitor-list-table-div').css({width:(avWidth - this.TreeviewWidth) + 'px', left: this.TreeviewWidth + 'px'});
        }
    }else {
        if(LocalConfiguration.VisitorsMapVisible && LocalConfiguration.VisitorsTreeviewVisible){
            this.HideTreeview();
            ...
            this.ShowTreeview();
            $('#visitor-list-table-div').css({width:avWidth + 'px', left: this.TreeviewWidth + 'px'});
            $('#geotracking').css({width:(avWidth - this.TreeviewWidth) + 'px', left: this.TreeviewWidth -1 + 'px'});
        }else {
            this.ShowTreeview();
            $('#visitor-list-table-div').css({width:avWidth + 'px', left: this.TreeviewWidth + 'px'});
        }
...
ChatVisitorClass.prototype.OnResize = function (){
    ...
    if(this.HasWindowWidthForSideBySideView()){
        ...
        if(LocalConfiguration.VisitorsMapVisible && LocalConfiguration.VisitorsTreeviewVisible){
            ...
            $('#geotracking').css({width:avWidth + 'px', left: 0});
        }else {
            $('#visitor-list-table-div').css({width:avWidth + 'px'});
        }
    }
