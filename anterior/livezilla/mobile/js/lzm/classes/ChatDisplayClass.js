...
CommonUIClass.prototype.GetPostHTML = function(_cpc,_showAvatar,_notify,_dlh){
    ...
    if (d(post.info_header))
    {
        ...
        var rfield='',addRow = '<tr><td class="TCBHF"><!--label--></td><td class="last"><!--value--></td></tr>';
        ...
        messageText = '<div class="TCBB"><table class="TCB header_class_placeholder"><tr><td class="TCBG" rowspan="100"></td><td class="TCBHF"><!--group_label-->&nbsp;&nbsp;</td><td class="last" style="white-space: normal;"><b><!--group_name--></b><!--receivers--></td><td class="TCBA" rowspan="100">' + rfield + '</td></tr>';
        ...
        if(_cpc.chatObj.Visitor.d != null)
        {
            for (var key in _cpc.chatObj.Visitor.d)
            {
                ...
                if(input != null && (input.id < 100 || !visitorInfoVisible))
                {
