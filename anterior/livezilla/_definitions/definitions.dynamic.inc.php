...
define("TEMPLATE_SCRIPT_TRACK",PATH_TEMPLATES . "jscriptv21/jstrack.tpl");
define("TEMPLATE_SCRIPT_CONNECTOR",PATH_TEMPLATES . "jscriptv21/jsconnector.tpl");
define("TEMPLATE_SCRIPT_DATA",PATH_TEMPLATES . "jscriptv21/jsdata.tpl");
define("TEMPLATE_SCRIPT_GROUPS",PATH_TEMPLATES . "jscriptv21/jsgroups.tpl");
define("TEMPLATE_SCRIPT_GLOBAL",PATH_TEMPLATES . "jscriptv21/jsglobal.js");
define("TEMPLATE_SCRIPT_INVITATION",PATH_TEMPLATES . "invitations/");

define("TEMPLATE_SCRIPT_OVERLAY_CHAT",PATH_TEMPLATES . "overlays/chatv21/");
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_STATUS",PATH_TEMPLATES . "overlays/chatv21/messagestatus.tpl");
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_PICTURE",PATH_TEMPLATES . "overlays/chatv21/messagepicture.tpl");
