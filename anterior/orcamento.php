				  ...
				  <div class="row">
					<div class="col-md-6-orcamento">
							...
							<form  method="POST">
								...
								<label><h1>Qual serviço você precisa?</h1></label>
									<div class="col-md-12">
											...
											<p><input type="checkbox"  name="8" id="area_verde" value="Sim" >
											<label>Programa de recuperação em áreas degradadas</label>
											<p><input type="checkbox"  name="9" id="area_jardim" value="Sim" >
											<label>Manutenção de áreas verdes e jardins</label>
											<p><input type="checkbox"  name="10" id="venda_gramado" value="Sim" onclick="document.getElementById('quantidade_gramado').disabled = !this.checked;">
											<label>Venda de Gramados</label>
											<p><input type="text"  name="11" id="quantidade_gramado" maxlength="15" disabled="disabled" >
											<label>Quantidade Gramado (m²)</label>
											<p><input type="checkbox"  name="12" id="implantacao_gramados" value="Sim" onclick="document.getElementById('quantidade_gramado').disabled = !this.checked;">
											<label>Implantação de Gramados</label>
											...
											<label>Quantidade Plantas (unidades)</label>
											<p><input type="checkbox"  name="15" id="implantacao_planta" value="Sim" onclick="document.getElementById('quantidade_planta').disabled = !this.checked;">
											<label>Implantação de Plantas</label>
											<p><label>Detalhe sua solicitação:</label><br>
											<textarea maxlength="790" data-msg-required="Digite sua observação." rows="10" class="form-control" name="16" id="projeto" required></textarea>
